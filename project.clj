(defproject metosin/reitit-parent "shadow-dom-fix-v3"
  ...
  :managed-dependencies [[metosin/reitit "shadow-dom-fix-v3"]
                         [metosin/reitit-core "shadow-dom-fix-v3"]
                         [metosin/reitit-dev "shadow-dom-fix-v3"]
                         [metosin/reitit-spec "shadow-dom-fix-v3"]
                         [metosin/reitit-schema "shadow-dom-fix-v3"]
                         [metosin/reitit-ring "shadow-dom-fix-v3"]
                         [metosin/reitit-middleware "shadow-dom-fix-v3"]
                         [metosin/reitit-http "shadow-dom-fix-v3"]
                         [metosin/reitit-interceptors "shadow-dom-fix-v3"]
                         [metosin/reitit-swagger "shadow-dom-fix-v3"]
                         [metosin/reitit-swagger-ui "shadow-dom-fix-v3"]
                         [metosin/reitit-frontend "shadow-dom-fix-v3"]
                         [metosin/reitit-sieppari "shadow-dom-fix-v3"]
                         [metosin/reitit-pedestal "shadow-dom-fix-v3"]
