(defproject reitit/reitit-parent "0.3.9"
  ...
  :managed-dependencies [[reitit/reitit "0.3.9"]
                         [reitit/reitit-core "0.3.9"]
                         [reitit/reitit-dev "0.3.9"]
                         [reitit/reitit-spec "0.3.9"]
                         [reitit/reitit-schema "0.3.9"]
                         [reitit/reitit-ring "0.3.9"]
                         [reitit/reitit-middleware "0.3.9"]
                         [reitit/reitit-http "0.3.9"]
                         [reitit/reitit-interceptors "0.3.9"]
                         [reitit/reitit-swagger "0.3.9"]
                         [reitit/reitit-swagger-ui "0.3.9"]
                         [reitit/reitit-frontend "0.3.9"]
                         [reitit/reitit-sieppari "0.3.9"]
                         [reitit/reitit-pedestal "0.3.9"]
